...
public class EntitySpruceBoat extends Entity {
    ...
    public EntitySpruceBoat(World var1) {
        super(var1);
    ...
    public EntitySpruceBoat(World var1, double var2, double var4, double var6) {
        this(var1);
    ...
    private void dropped() {
        ...
        for(var3 = 0; var3 < 3; ++var3) {
            this.dropItemWithOffset(mod_GreatHalva.SprucePlanks.blockID, 1, 0.0F);
        }
