...
public abstract class Entity {
    ...
    public EntityItem dropItem(int var1, int var2) {
        return this.dropItemWithOffset(var1, var2, 0.0F, 0);
    }
    
    public EntityItem dropItem(int var1, int var2, int var3) {
        return this.dropItemWithOffset(var1, var2, 0.0F, var3);
    }

    public EntityItem dropItemWithOffset(int var1, int var2, float var3, int meta) {
        return this.entityDropItem(new ItemStack(var1, var2, meta), var3);
    }
